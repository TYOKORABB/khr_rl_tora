...
from khr_quad_env7 import KHRQuadEnv  # v10: 上記 + 左右対称化/直進/2階平滑化の罰(leg_load_balance/drift/action_smoothness2)
...
def main():
    ...
    parser.add_argument("-e", "--exp_name", type=str, default="khr-quadruped10") # v10: 左右対称化+減速+低負荷
