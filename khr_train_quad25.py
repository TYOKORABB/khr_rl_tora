...
既定 exp_name は khr-quadruped25。v1〜v23 の成果物には一切触れない。
...
from khr_quad_env19 import KHRQuadEnv  # v25: 上記 + 累積ヘディング誤差を「観測」にも追加
...
def main():
    ...
    parser.add_argument("-e", "--exp_name", type=str, default="khr-quadruped25") # v25: 累積ヘディング誤差を観測に追加し個体差下の横ずれを是正
