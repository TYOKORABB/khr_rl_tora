...
既定 exp_name は khr-quadruped27-p075。v1〜v23 の成果物には一切触れない。
...
from khr_quad_env19 import KHRQuadEnv  # v27: 環境は v25 と同一（設定のみ変更: prelanding 0.75）
...
def get_cfgs():
    ...
    reward_cfg = {
        ...
        "feet_orientation_prelanding_phase": 0.75,   # [v27] 0.85→0.75 着地に向けて足裏を水平に構える時間を延ばす  # v18: 着地直前(遊脚終盤)からも足裏水平を要求＝足裏全面で接地
...
def main():
    ...
    parser.add_argument("-e", "--exp_name", type=str, default="khr-quadruped27-p075") # v27: 着地直前の足裏水平要求を 0.85→0.75 に拡大
