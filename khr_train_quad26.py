...
既定 exp_name は khr-quadruped26。v1〜v23 の成果物には一切触れない。
...
from khr_quad_env20 import KHRQuadEnv  # v26: 上記 + 足裏水平の罰を着地〜立脚中期に集中
...
def get_cfgs():
    ...
    reward_cfg = {
        ...
        "feet_orientation_pushoff_phase": 0.35,   # [v26] 蹴り出し期は足裏水平を要求しない（罰の7割がここに浪費されていた）
...
def main():
    ...
    parser.add_argument("-e", "--exp_name", type=str, default="khr-quadruped26") # v26: 足裏水平の罰を着地〜立脚中期に集中（蹴り出しは罰さない）
